...
/*
 * Template Name: Специалисты карточка
*/
...
<div class="block_carousel_item block_carousel_item_specialist">
    ...
    <div class="block_carousel_item_descr_spec"><?php the_meta(); ?></div>
    <div class="block_carousel_item_descr_spec_img"><?php the_content(); ?></div>
</div>
