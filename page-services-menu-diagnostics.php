<?php 
/*
 * Template Name: Диагностические исследования
*/
?>
    ...
    <div class="services-menu">
        ...
        <div class="services-content">
            ...
            <div class="services-content_wrapper" id="content"> 
               ...
               <?php $slider9 = new WP_Query(array('post_type' => 'slider9'));?>     
                    <?php if( $slider9->have_posts() ) : ?>                        
                        <?php while ( $slider9->have_posts() ) : $slider9->the_post(); ?>   
