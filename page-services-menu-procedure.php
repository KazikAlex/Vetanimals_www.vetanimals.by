<?php 
/*
 * Template Name: Процедурный кабинет
*/
?>
    ...
    <div class="services-menu">
        ...
        <div class="services-content">
            ...
            <div class="services-content_wrapper" id="content"> 
               ...
               <?php $slider5 = new WP_Query(array('post_type' => 'slider5'));?>     
                    <?php if( $slider5->have_posts() ) : ?>                        
                        <?php while ( $slider5->have_posts() ) : $slider5->the_post(); ?>   
