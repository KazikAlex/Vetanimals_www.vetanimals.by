...
/*
 * Template Name: Пациенты рептилии
*/
?>
...
<?php $slider15 = new WP_Query(array('post_type' => 'slider15'));?>      
    <?php if( $slider15->have_posts() ) : ?> 
        <div class="container">
            <div class="patient1-wrapper">
                <?php while ( $slider15->have_posts() ) : $slider15->the_post(); ?>     
