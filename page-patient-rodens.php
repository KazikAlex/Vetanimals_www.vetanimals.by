...
/*
 * Template Name: Пациенты грызуны
*/
?>
...
<?php $slider18 = new WP_Query(array('post_type' => 'slider18'));?>      
    <?php if( $slider18->have_posts() ) : ?> 
        <div class="container">
            <div class="patient1-wrapper">
                <?php while ( $slider18->have_posts() ) : $slider18->the_post(); ?>     
