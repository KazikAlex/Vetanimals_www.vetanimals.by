<?php 
/*
 * Template Name: Гинекология и урология
*/
?>
    ...
    <div class="services-menu">
        ...
        <div class="services-content">
            ...
            <div class="services-content_wrapper" id="content"> 
               ...
               <?php $slider10 = new WP_Query(array('post_type' => 'slider10'));?>     
                    <?php if( $slider10->have_posts() ) : ?>                        
                        <?php while ( $slider10->have_posts() ) : $slider10->the_post(); ?>   
