    ...
    <div class="services-menu">
        ...
        <div class="services-content">
            ...
            <div class="services-content_wrapper" id="content"> 
               ...
               <?php $slider11 = new WP_Query(array('post_type' => 'slider11'));?>     
                    <?php if( $slider11->have_posts() ) : ?>                        
                        <?php while ( $slider11->have_posts() ) : $slider11->the_post(); ?>   
