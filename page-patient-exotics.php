...
/*
 * Template Name: Пациенты экзотические
*/
?>
...
<?php $slider17 = new WP_Query(array('post_type' => 'slider17'));?>      
    <?php if( $slider17->have_posts() ) : ?> 
        <div class="container">
            <div class="patient1-wrapper">
                <?php while ( $slider17->have_posts() ) : $slider17->the_post(); ?>     
