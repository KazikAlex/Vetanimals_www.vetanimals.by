...
<?php $slider16 = new WP_Query(array('post_type' => 'slider16'));?>      
    <?php if( $slider16->have_posts() ) : ?> 
        <div class="container">
            <div class="patient1-wrapper">
                <?php while ( $slider16->have_posts() ) : $slider16->the_post(); ?>     
